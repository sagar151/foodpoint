...
<html lang="en">
  ...
  <img src="images/fast-food2.png" class="card-img-top" alt="...">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" class="d-flex">
      <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="d-grid gap-1">
                                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#custprofile">
  Update Profile
</button>
<button type="button" class="btn btn-secondary" data-bs-toggle="modal" onclick="location.href='logout.php'"><i class="fa fa-power-off"></i>
  Log out
</button>
</div>  
          </ul>
...
<section class="hero bg-image opacity-3" id="sliderbanner" >
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Order Delivery & Take-Out </h1>
                <h5 class="font-white space-xs">Find restaurants, specials, and coupons for free</h5>
                <div class="banner-form">
                    <form class="form-inline" method="post" name="form1" id="idform" action ="index31.php">
  ...
  <div class="row">
    <?php
      ...
      {	
        ...
        <div class="card h-400 d-inline-block">
        <div class="h-25 align-middle" style="width: 225px;">
        <img src="admin/Res_img/dishes2/'.$r['img'].'" alt="...">
        </div>                                        
        <div class="card-body">
...
<button type="button" class="btn btn-primary" id="selcbutton" data-bs-toggle="modal" data-bs-target="#exampleModal">
  Country
</button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
        <input type="radio" class="btn-check" name="btncountry" value="india" id="btnradio1" autocomplete="off" checked>
        <label class="btn btn-outline-primary" for="btnradio1">India</label>

        <input type="radio" class="btn-check" name="btncountry" value="usa" id="btnradio2" autocomplete="off">
        <label class="btn btn-outline-primary" for="btnradio2">USA</label>

        <input type="radio" class="btn-check" name="btncountry" value="europe" id="btnradio3" autocomplete="off">
        <label class="btn btn-outline-primary" for="btnradio3">Europe</label>
      </div>
      </div>

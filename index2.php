...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="<?php echo $url;?>"> <img class="img-rounded" src="images/food-logo.png" alt="" width=60 height=50 style="position:absolute; top:7%; left:0.5%;"> </a>
            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="form1" id="idform" action ="index3.php">
                    ...
                    function button1($db) {
                        ...
                        <table id="myTable">
                            <tbody>
                                ...
                                //    $query_res= mysqli_query($db,"select * from dishes WHERE title LIKE '%".$nsearch."%'"); 
                                    while($r=mysqli_fetch_array($query_res))
                                    {	
                                        echo '  <div class="col-xs-12 col-sm-3 col-md-3 food-item">
    ...
    <script>
        function getname($name){
            var name = $name;
            console.log(name);
            document.getElementById("hiddencontainer") = name;
        }
        //document.getElementsByClassName('btn theme-btn btn-lg')[0].click();
    </script>
</body>
</html>